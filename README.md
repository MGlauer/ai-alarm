...
A mix of manual implementation and code generated by Claude 5 Sonet was used to develop this system. As a first step, a
design document was manually created to define the system architecture. This document was then used as a guiding tool to
generate parts of the system. In order to keep the architecture sound, elements of the system architecture were
developed in separate steps (datamodel -> agents/tools -> situation interpreter -> controller -> API -> Frontend) and
manually checked after each step.
